...
DigiKeyboard.sendKeyPress(0); // 松开 DigiKeyboard.sendKeyStroke(KEY_ENTER); // 按回车 
...
DigiKeyboard.sendKeyPress(0); 
DigiKeyboard.sendKeyStroke(KEY_ENTER); 
DigiKeyboard.delay(500); // 退出CMD窗口，并打开文件 
DigiKeyboard.sendKeyPress(MOD_SHIFT_LEFT); 
DigiKeyboard.println("notepad C:\\pwlog.txt && exit"); 
DigiKeyboard.sendKeyPress(0); 
DigiKeyboard.delay(500); } void loop() { // put your main code here, to run repeatedly: }
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3OTk3Nzg2NSwtMTIzNzEwNTU4MSw2OT
k3OTUwNTldfQ==
-->